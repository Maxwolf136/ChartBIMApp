...
import { LoadIfcFile } from "../../../bim-components/LoadIfc";
import { LoadIFCUI } from "../../../bim-components/LoadIfc/src/user-interface";
...
export default (components: OBC.Components) => {
  ...
  loadBtn.tooltipText =
    ...
    loadBtn.addEventListener("change",(e:Event)=>{

      console.log("change listener: ",e);
    })
